" Vim syntax file
" Language:	        QBS
" Maintainer:	        John Kaul <john.kaul@outlook.com>
" URL:	                nowhere.com
" Changes:	        Initial - 03.18.15
" File Last Updated:    05.06.16 8:19:12 AM
...
if !exists("main_syntax")
  ...
  let main_syntax = 'qbs'
elseif exists("b:current_syntax") && b:current_syntax == "qbs"
  finish
endif
...
if version < 600 && exists("qbs_fold")
  unlet qbs_fold
endif
