...
augroup indentation
	...
	" Tab width settings
	autocmd Filetype html,xhtml setlocal expandtab ts=2 sts=2 sw=2
	autocmd Filetype javascript setlocal ts=4 sts=4 sw=4
	autocmd FileType python setlocal expandtab shiftwidth=4 tabstop=4 softtabstop=4 smarttab
	autocmd Filetype tex setlocal ts=4 sts=4 sw=4
	autocmd Filetype vim setlocal ts=4 sts=4 sw=4
	autocmd Filetype sh setlocal expandtab ts=2 sts=2 sw=2
	" Formatters
	autocmd FileType python let b:formatter="autopep8 -"
	autocmd FileType c let b:formatter="indent -nbad -bap -nbc -bbo -hnl -br -brs -c33 -cd33 -ncdb -ce -ci4 -cli0 -d0 -di1 -nfc1 -i8 -ip0 -l80 -lp -npcs -nprs -npsl -sai -saf -saw -ncs -nsc -sob -nfca -cp33 -ss -ts8 -il1"
	autocmd FileType tex,bib let b:formatter="latexindent.sh"
	autocmd FileType sh let b:formatter="bashindent.sh"
...
" Actual word count for LaTeX documents
